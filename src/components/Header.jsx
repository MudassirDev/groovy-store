    ...
    return (<>
        <header className='flex border-b border-gray-300 py-3 px-4 sm:px-10 bg-white min-h-[65px] tracking-wide relative z-50 sticky top-0'>
            <div className='flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full'>
                ...
                <div id="collapseMenu"
                    className={`max-lg:w-full max-lg:fixed max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50 ${isMenuOpen ? "" : "max-lg:hidden"}`}>
                    <button
                        onClick={toggleMenu}
                        id="toggleClose"
                ...
                <div className='flex gap-4 ml-auto w-full sm:w-auto'>
                    ...
                    <button onClick={toggleMenu} id="toggleOpen" className={`lg:hidden cursor-pointer ${isMenuOpen ? "hidden" : ""}`}>
